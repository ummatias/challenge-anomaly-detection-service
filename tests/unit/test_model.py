...
class TestPredict:
    ...
    def test_boundary_exactly_at_threshold_is_not_anomaly(self):
        ...
        assert m.predict(threshold) is False # exactly at threshold, should not be anomaly
...
class TestLoadParams:
    def test_round_trip(self):
        ...
        assert m2.predict(1000.0) == m1.predict(1000.0) # Both should agree on this extreme value
        assert m2.predict(25.0) == m1.predict(25.0) # Both should agree on this normal value
